...
@section('title', 'Modificar / Materias | Asistencia UMA')

@section('content_header')
    <h1 style="text-align: center">Modificación de Materias</h1>
@stop
                ...
                <form action="{{ route('materias.update', $materias->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mx-auto">
                        <div class="col-md-6 col-lg-6">
                            <x-adminlte-input type="text" class="form-control" id="nombreMateria" name="nombreMateria" autocomplete="name" aria-describedby="emailHelp" label="Nombre" fgroup-class="col-me-3" value="{{ $materias->nombreMateria }}"/>
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <x-adminlte-input type="text" class="form-control" id="numero" name="numero" aria-describedby="emailHelp" label="Número" fgroup-class="col-me-3" value="{{ $materias->numero }}" />
                        </div>
                    </div>
                    <div class="row mx-auto">
                        <div class="col-md-6 col-lg-6">
                            <x-adminlte-input type="text" class="form-control" id="requisito" name="requisito" aria-describedby="emailHelp" label="Requisito" fgroup-class="col-me-3" value="{{ $materias->requisito }}" />
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <div class="mb-3">
                                <x-adminlte-input type="text" class="form-control" id="unidadValorativa" name="unidadValorativa"
                                    aria-describedby="emailHelp" label="Unidad Valorativa" fgroup-class="col-me-3" value="{{ $materias->unidadValorativa }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mx-auto">
                    ...
                    <div class="row mx-auto"  id="jornadaDivididaFields1" style="display: none;">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <x-adminlte-select class="form-control " id="diaHorario_id1" name="diaHorario_id1" aria-label="Default select example">
                            </x-adminlte-select>
                        </div>
                        <div class="col-md-6 col-lg-6">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <x-adminlte-select class="form-control " id="diaHorario_id2" name="diaHorario_idv2" aria-label="Default select example">
                            </x-adminlte-select>
                        </div>
                    </div>
                    <div class="row mx-auto">
                        ...
                        <div style="margin-left: 10px">
                            <button type="submit" class="btn btn-danger mt-3" id="agregar">Modificar Materia</button>
                        </div>
                    </div>
                </form>
            </div>
...
@section('js')
    <script>
        ...
        document.getElementById('facultad_id').addEventListener('change', function() {
            ...
            // Realizar una llamada utilizando Axios para obtener los municipios relacionados con el departamento seleccionado
            axios.get('/admin/materias/obtenerMaterias/' + facultad_id)
                .then(function(response) {
                    var carreras = response.data;

                    // Limpiar el segundo select y agregar las carreras obtenidos
        ...
        document.getElementById('dia_id1').addEventListener('change', function() {
            ...
            .then(function(response) {
                var diaTurno = response.data;
                var turnoSelect = document.getElementById('diaHorario_id1');
                turnoSelect.innerHTML = '<option selected disabled>Seleccione el turno</option>';
                diaTurno.forEach(function(diaTurnos) {
                    turnoSelect.innerHTML += '<option value="' + diaTurnos.diaHorarios_id + '">' + diaTurnos.turno +' ('+diaTurnos.horaApertura+'-'+diaTurnos.horaFinalizacion+')'+ '</option>';
        ...
        document.getElementById('dia_id2').addEventListener('change', function() {
            ...
            .then(function(response) {
                var diaTurno = response.data;
                var turnoSelect = document.getElementById('diaHorario_id2');
                turnoSelect.innerHTML = '<option selected disabled>Seleccione el turno</option>';
                diaTurno.forEach(function(diaTurnos) {
                    turnoSelect.innerHTML += '<option value="' + diaTurnos.diaHorarios_id + '">' + diaTurnos.turno +' ('+diaTurnos.horaApertura+'-'+diaTurnos.horaFinalizacion+')'+ '</option>';
                    var maxItemsToShow = 3;
