...
@section('content_header')
    <h1 style="text-align: center">Reporte por Materias</h1>
@stop
        ...
        <div class="row">
            ...
            @foreach ($sortedMateriasUsuario as $materiaUsuario)
                <div class="col-md-4 col-sm-6 mb-3">
                     <a href="{{ route('reporteMateriaCatedratico',['user_id'=>$materiaUsuario->user_id, 'materia_id'=>$materiaUsuario->materias_id]) }}"><div class="card card-hover">
