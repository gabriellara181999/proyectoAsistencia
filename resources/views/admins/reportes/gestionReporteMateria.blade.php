...
@section('title', 'Reportes / Catedratico / Materias | Asistencia UMA')

@section('content_header')
    <h1 style="text-align: center">Reporte por Materia</h1>
@stop
            ...
            <table id="example" class="table-bordered table-hover" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="d-none d-md-table-cell">Fecha / Hora</th>
                        <th class="d-none d-md-table-cell">Alumnos Inscitos</th>
                        <th class="d-none d-md-table-cell">Asistentes</th>
                        <th class="d-none d-md-table-cell">Inasistentes</th>
                        <th class="d-none d-md-table-cell acciones">Acciones</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @foreach ($materiaAsistencia as $materiaAsistencias)
                        <tr>
                            ...
                            <td>{{ $materiaAsistencias->nombreMateria }}</td>
                            <td class="d-none d-md-table-cell">{{ ucfirst(Carbon\Carbon::parse($materiaAsistencias->fechaAsistencia)->isoFormat('dddd D-MMM-YYYY')) }} | {{ \Carbon\Carbon::parse($materiaAsistencias->fechaAsistencia)->format('h:i A') }}</td>
                            <td class="d-none d-md-table-cell">{{ $materiaAsistencias->inscritoMateria }}</td>
                            <td class="d-none d-md-table-cell">{{ $materiaAsistencias->estudianteAsistencia }}</td>
                            <td class="d-none d-md-table-cell">{{ $materiaAsistencias->inscritoMateria - $materiaAsistencias->estudianteAsistencia }}</td>
                            <td class="d-none d-md-table-cell"><a class="btn btn-dark rounded mx-1 shadow" href="{{ route('reporteMateriaCatedraticoAlumno', $materiaAsistencias->id) }}">
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            var materia = {!! json_encode($materiaAsistencias->nombreMateria) !!};
