...
@section('title', 'Crear / Estudiantes | Asistencia UMA')

@section('content_header')
    <h1 style="text-align: center">Creación de Estudiantes</h1>
@stop
...
<style>
    ...
    <div class="col-lg-9 mb-3 mx-auto">
        <div class="card shadow">
            <div class="card-body">
                <form action="{{ route('estudiantes.index') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mx-auto">
                        <div class="col-md-6 col-lg-6">
                            <x-adminlte-input type="text" class="form-control" id="name" name="name" autocomplete="name" aria-describedby="emailHelp" label="Nombres" fgroup-class="col-me-3" value="{{ old('name') }}"/>
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <x-adminlte-input type="text" class="form-control" id="apellido" name="apellido" aria-describedby="emailHelp" label="Apellidos" fgroup-class="col-me-3" value="{{ old('apellido') }}" />
                        </div>
                    </div>
                    <div class="row mx-auto">
                        <div class="col-md-6 col-lg-6">
                            <x-adminlte-input type="date" class="form-control" id="fechaNacimiento" name="fechaNacimiento" aria-describedby="emailHelp" label="Fecha de Nacimiento" fgroup-class="col-me-3" value="{{ old('fechaNacimiento') }}" />
                        </div>
                        <div class="col-md-6 col-lg-6">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="mb-3">
                                <x-adminlte-input type="text" class="form-control" id="numeroEstudiante" name="numeroEstudiante"
                                    aria-describedby="emailHelp" label="N° de Estudiante" placeholder="AA111111111" fgroup-class="col-me-3" value="{{ old('numeroEstudiante') }}" autocomplete="alumnonumber"/>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <div class="mb-3">
                                <x-adminlte-input type="email" class="form-control" id="email" name="email"
                                    aria-describedby="emailHelp" label="Correo electrónico" fgroup-class="col-me-3" value="{{ old('email') }}" autocomplete="username"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mx-auto">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="mb-3">
                                <x-adminlte-input type="text" class="form-control" id="telefono" name="telefono" placeholder="____-____" pattern="\d{4}-\d{4}" aria-describedby="emailHelp" label="Teléfono" fgroup-class="col-me-3" value="{{ old('telefono') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mx-auto">
                    ...
                    <div class="row mx-auto">
                        ...
                        <div style="margin-left: 10px">
                            <button type="submit" class="btn btn-danger mt-3" id="agregar">Agregar Estudiante</button>
                        </div>
                    </div>
                </form> 
            </div>
