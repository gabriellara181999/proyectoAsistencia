...
@section('title', 'Crear / Usuarios | Asistencia UMA')
                ...
                <form action="{{ route('usuarios.index') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="mb-3">
                                <x-adminlte-input type="email" class="form-control" id="email" name="email"
                                    aria-describedby="emailHelp" label="Correo electrónico" fgroup-class="col-me-3" value="{{ old('email') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mx-auto">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="mb-3">
                                <x-adminlte-input type="text" class="form-control" id="numeroCatedratico" name="numeroCatedratico"
                                    aria-describedby="emailHelp" label="N° de Catedrático" placeholder="AA111111111" fgroup-class="col-me-3" value="{{ old('numeroCatedratico') }}" autocomplete="user"/>
                            </div>
                        </div>                                            
                    </div>
                    <div class="row mx-auto">
                    ...
                    <div class="row mx-auto">
                        <div class="col">
                            <div class="form-group">
                                ...
                                {{-- {!! Form::select('roles[]', $roles->pluck('name', 'id'), old('roles'), ['class' => 'form-control']) !!} --}}
                    ...
                    <div class="row mx-auto">
                        ...
                        <div style="margin-left: 10px">
                            <button type="submit" class="btn btn-danger mt-3" id="agregar">Agregar Usuario</button>
                        </div>
                    </div>
                </form>
            </div>
